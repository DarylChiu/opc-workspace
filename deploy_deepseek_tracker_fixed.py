...
def create_system_files():
    ...
    # 创建 deepseek_tracker_service.py
...
'''
    ...
    service_path = workspace / "deepseek_tracker_service.py"
    if not service_path.exists():
        with open(service_path, 'w') as f:
            f.write(service_content)
        print("  已创建: deepseek_tracker_service.py")
    
    # 创建 test_deepseek_integration.py
...
'''
    ...
    test_path = workspace / "test_deepseek_integration.py"
    if not test_path.exists():
        with open(test_path, 'w') as f:
            f.write(test_content)
        print("  已创建: test_deepseek_integration.py")
    
    # 创建 start_deepseek_tracker.sh
...
'''
    ...
    start_script_path = workspace / "start_deepseek_tracker.sh"
    if not start_script_path.exists():
        with open(start_script_path, 'w') as f:
            f.write(start_script_content)
        print("  已创建: start_deepseek_tracker.sh")
    
    # 创建 README_Deepseek_Tracker.md
    readme_content = '''# Deepseek成本跟踪系统
...
'''
    ...
    readme_path = workspace / "README_Deepseek_Tracker.md"
    if not readme_path.exists():
        with open(readme_path, 'w') as f:
            f.write(readme_content)
        print("  已创建: README_Deepseek_Tracker.md")
    
    # 设置执行权限
    if start_script_path.exists():
        import stat
        start_script_path.chmod(start_script_path.stat().st_mode | stat.S_IEXEC)
        print("  已设置执行权限: start_deepseek_tracker.sh")

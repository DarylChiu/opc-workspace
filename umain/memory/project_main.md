...
| 2026-08 | ≤$85（变现战略 API 预算约束） | $24.51 | 8/16 23:45 归集（Balance 台账：今日 $0.21 / 本月 $24.51 / 全量 $150.30，/api/costs 已对齐） |
| 累计 | — | ~$150.30 | 🔴 7月超支20.0% |
...
| 本周进展 | 8/16 交付 docs/daryl_training_plan_20260816.md v1.0（8周4分化：下肢/上肢推/下肢+体能/上肢拉 + 渐进超负荷 + 30min压缩版 + 骑行2次/周 + 饮食 2500kcal/120g蛋白 + 补剂优先级（肌酸必买/蛋白粉镁可选/BCAA智商税）+ 睡眠6条 + 高度近视安全清单）→ 21:30 v1.1 全身版修正（Daryl 纠正：羽毛球体感下降是触发点非目标，已捕获进信号池；改全身训练 4 次/周 A/B轮换 + 骑行 3 次/周） |
